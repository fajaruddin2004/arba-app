              ...
              {showAddMK && (
                <TiltCard className="border border-amber-500/30 bg-gradient-to-br from-amber-500/5 to-transparent">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <select value={mkForm.hari} onChange={e => setMkForm({ ...mkForm, hari: e.target.value })} className="bg-black/50 border border-white/10 rounded-xl p-3 text-zinc-400 focus:border-amber-500 focus:outline-none">
                    ...
                    <input value={mkForm.waktu} onChange={e => setMkForm({ ...mkForm, waktu: e.target.value })} placeholder="Waktu (cth: 10:00 - 12:30)" className="bg-black/50 border border-white/10 rounded-xl p-3 text-white focus:border-amber-500 focus:outline-none" />
                    <input value={mkForm.ruangan} onChange={e => setMkForm({ ...mkForm, ruangan: e.target.value })} placeholder="Ruangan (cth: Lab Komputer 1)" className="bg-black/50 border border-white/10 rounded-xl p-3 text-white focus:border-amber-500 focus:outline-none" />
                  </div>
